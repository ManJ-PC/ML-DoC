...
\usepackage{xcolor} % added for color table
\usepackage{color}
...
%%----------------------------------------
\title{Machine learning in the diagnosis of disorders of consciousness using SMART}
\author{Manuel Curral}


%% Uncomment next line for date of submission
%\thesisdate{July 31, 2008}

%%C>omment next line for copyright text if used
\copyrightnotice{Manuel José Pereira Curral, 2021}

\supervisor{Supervisor}{Professor Doutor Jaime Cardoso}
\supervisor{Co-Supervisor}{Professora Liliana Teixeira}
\supervisor{Co-Supervisor}{Professor Doutor Nuno Rocha}
